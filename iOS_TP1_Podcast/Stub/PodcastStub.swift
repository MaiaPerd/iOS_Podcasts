...
struct PodcastStub {
    ...
    static func getListPodcast()->[Podcast]{
        return [
            Podcast(id: 1, titre: "Chaleur Humaine", auteur: "Le Monde", description: "Comment faire face au défi climatique ? Tous les mardis, Nabil Wakim et la rédaction du Monde invitent des experts pour comprendre les enjeux et trouver des solutions. Chaleur Humaine est aussi une newsletter. Inscrivez-vous pour recevoir chaque mardi notre sélection d'articles : https://www.lemonde.fr/newsletters/chaleur-humaine/ Hébergé par Acast. Visitez acast.com/privacy pour plus d'informations.", note: 4.8, nbVote: 460, genre: "Actualités", rythme: "Chaque Semaine", imageName: "ChaleurHumaine", episodes: [getPodcastEpisode()]),
            ...
            Podcast(id: 3, titre: "La science, CQFD", auteur: "France Culture", description: "Une heure de savoir autour des sciences, toutes les sciences, et sur les problématiques éthiques, politiques, économiques et sociales qui font l'actualité de la recherche. Du lundi au vendredi de 16h à 17h avec Natacha Triou. Rendez-vous sur l'application Radio France pour découvrir tous les autres épisodes.", note: 4.4, nbVote: 1800, genre: "Sciences", rythme: nil, imageName: "LeCodeAChange", episodes: getListPodcastEpisode()),
